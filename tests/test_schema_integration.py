...
def test_compare_from_schema_string_sdl():
    ...
    expected_changes = {
        ...
        (
            'Directive locations of `@yolo` changed '
            'from `FIELD | FRAGMENT_SPREAD | INLINE_FRAGMENT` to `FIELD | FIELD_DEFINITION`'
        ),
        ...
        'Field `Query.a` description changed from `Just a simple string` to `None`',
